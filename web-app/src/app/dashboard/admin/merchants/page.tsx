...
export default function AdminMerchants() {
  ...
  // Fetch merchants (filtering from admin/users)
  const fetchMerchants = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setMerchants(users.filter((u: any) => u.user_type === 'enterprise'))
      } else {
  ...
  return (
    <div>
      <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">Jesyon Ti Machann</h2>
